...
import ChargebackListAdministrativo from '@/components/ui/chargeback-list-administrativo';

export default function SetorAdministrativoChargebacks() {
  const { user } = useAuth();
